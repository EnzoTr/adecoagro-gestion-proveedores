        ...
        <div class="suppliers form content glassy">
            ...
            <fieldset class=" d-flex flex-column gap-3">
                ...
                <?php
                    ...
                    echo $this->Form->control('address', ['label'=>false,'placeholder' => 'Direccion', 'class'=>'border-0 bg-secondary bg-opacity-10 glassy rounded-4 p-5']);
                    echo $this->Form->control('phone', ['label'=>false,'placeholder' => 'Telefono', 'class'=>'border-0 bg-secondary bg-opacity-10 glassy rounded-4 p-5']);
                    echo $this->Form->control('email', ['label'=>false,'placeholder' => 'Email', 'class'=>'border-0 bg-secondary bg-opacity-10 glassy rounded-4 p-5']);
